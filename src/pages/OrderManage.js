    ...
    async print() {
        ...
        return `
            ...
            <p id="delivering" class="title_action border-r text-semibold py-1 text-center">Đang giao hàng (${delivering.length})</p> 
                <p id="received" class="title_action border-x text-semibold py-1 text-center">Đã nhận hàng (${received.length})</p> 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm font-bold">
                              <a href="/order_manage/detail/id=${e.id}" id="btnDelele" class="text-indigo-600 hover:text-indigo-900"><button data-id=${e.id} id="btn_detail">Xem chi tiết</button></a>
                              <span> | </span>
                  ...
                  <table class="table_show delivering min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm font-bold">
                              <a href="/order_manage/detail/id=${e.id}" class="text-indigo-600 hover:text-indigo-900"><button data-id=${e.id} id="btn_detail">Xem thông tin</button></a>
                              <span>|</span>
                  ...
                  <table class="table_show received min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class=" bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm font-bold">
                              <a href="/order_manage/detail/id=${e.id}" id="btnDelele" class="text-indigo-600 hover:text-indigo-900"><button data-id=${e.id} id="btn_detail">Xem thông tin</button></a>
                            </td>
                          </tr>
                      `).join("")}
      ...
      afterRender() {
        ...
        btnCanceled.forEach(btn => {
          ...
          btn.addEventListener("click", async () => {
            ...
            .then(() => reRender(Order_manage, "#main"))
          })
        })
