...
const UpdateProduct = {
        ...
        return `
            ...
            <form class="w-full max-w-4xl m-auto mb-10" method="POST" id="form-update-product">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="mt-10 w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input type="text" id="old_cate" value="${data.cate_id}" hidden/>
                    </div>
                </div>
    ...
    afterRender(updateId) {
        $("#form-update-product").validate({
            ...
            const cate_name = document.querySelector("#cate_name").value
            formData.append("file", file);
            formData.append("upload_preset", CLOUDINARY_PRESET_KEY);
            let img = "";
            let cate_id = ""
            if(cate_name == ""){
                cate_id = document.querySelector("#old_cate").value
            }else{
                cate_id = document.querySelector("#cate_name").value
            }
            if (file !== undefined) {
